task_name=$1
Data_path="/workspace/user_code/violatang/l2-paper/movielens_bpr"
Model_path="/ceph/szgpu/10929/violatang/l2r/models/movielens_bpr"
...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Model_path/tmp_model_${task_name}/ --output_dir=$Data_path/tmp_output/ --setting_file=./example/offline_setting_v3/pairwise_regression_EM_mtl_nopointcorr_nodecay_extractipstrue_linearndcg_evallinear_exp_settings.json"
echo $SETTING_ARGS
