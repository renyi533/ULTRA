...
Data_path="/data/notebooks/jupyter-notebook/violatang/l2r-paper/MSLR_10k_letor"   ## Data path where to unzip the data
...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_epsilon_${task_name}/ --output_dir=$Data_path/tmp_output/ --setting_file=./example/offline_setting_epsilon/pairwise_regression_EM_mtl_nopointcorr_nodecay_extractips_corrlr0.1_exp_settings.json"
echo $SETTING_ARGS
# Run model
