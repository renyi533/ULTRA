...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_epsilon_${task_name}/ --output_dir=$Data_path/tmp_output_${task_name}/ --setting_file=./example/offline_setting_epsilon/pairwise_debias_mtl_exp_settings.json"
echo $SETTING_ARGS
# Run model
