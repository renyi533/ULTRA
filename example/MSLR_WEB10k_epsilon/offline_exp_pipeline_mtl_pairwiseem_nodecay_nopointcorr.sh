...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_epsilon_${task_name}/ --output_dir=$Data_path/tmp_output/ --setting_file=./example/offline_setting_epsilon/pairwise_regression_EM_mtl_nopointcorr_nodecay_exp_settings.json"
echo $SETTING_ARGS
# Run model
