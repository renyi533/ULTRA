...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_${task_name}/ --output_dir=$Data_path/tmp_output/ --setting_file=./example/offline_setting_v3/biastower_mtl_sep_evallinear_exp_settings.json"
echo $SETTING_ARGS
