task_name=$1
Data_path="/data/notebooks/jupyter-notebook/violatang/l2r-paper/MSLR_30k_letor_v2/MSLR_30k_letor"   ## Data path where to unzip the data
...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_${task_name}/ --output_dir=$Data_path/tmp_output/ --setting_file=./example/offline_setting_v3/pairwise_regression_EM_mtl_nopointcorr_nodecay_extractipstrue_linearndcg_evallinear_exp_settings.json"
echo $SETTING_ARGS
