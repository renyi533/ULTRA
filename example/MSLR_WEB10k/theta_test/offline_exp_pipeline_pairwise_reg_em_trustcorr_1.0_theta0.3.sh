...
algo_name=pairwise_reg_em_trustcorr_1.0_theta0.3
rm -rf $Data_path/tmp_model_$algo_name/*

export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_$algo_name/ --output_dir=$Data_path/tmp_output_$algo_name/ --setting_file=./example/offline_setting_theta/pairwise_regression_EM_noisy_trustcorr_1.0_exp_settings_theta0.3.json"
echo $SETTING_ARGS
# Run model
