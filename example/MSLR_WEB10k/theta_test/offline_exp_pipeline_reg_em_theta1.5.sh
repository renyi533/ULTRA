...
algo_name=regression_em_theta1.5
rm -rf $Data_path/tmp_model_$algo_name/*

export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_$algo_name/ --output_dir=$Data_path/tmp_output_$algo_name/ --setting_file=./example/offline_setting_theta/regression_EM_noisy_exp_settings_theta1.5.json"
echo $SETTING_ARGS
# Run model
