...
Data_path="/data/violatang/l2r-paper/data/MSLR_10k_letor"   ## Data path where to unzip the data
...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_${task_name}/ --output_dir=$Data_path/tmp_output/ --setting_file=./example/offline_setting/pairwise_regression_EM_mtl_nopointcorr_warmupips_exp_settings.json"
echo $SETTING_ARGS
# Run model
python3 main.py --max_train_iteration=1000 $SETTING_ARGS
