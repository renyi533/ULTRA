...
algo_name=naive_pairwise
rm -rf $Data_path/tmp_model_$algo_name/*

export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_$algo_name/ --output_dir=$Data_path/tmp_output_$algo_name/ --setting_file=./example/offline_setting/naive_algorithm_pairwise_noisy_exp_settings.json"
echo $SETTING_ARGS
# Run model
