...
algo_name=biastower_mtl
rm -rf $Data_path/tmp_model_$algo_name/*

export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_$algo_name/ --output_dir=$Data_path/tmp_output_$algo_name/ --setting_file=./example/offline_setting_prod/biastower_mtl_sep_clickdot_wtsum_evalreward_exp_settings.json"
echo $SETTING_ARGS
# Run model
