Data_path="./MovieLens"   ## Data path where to unzip the data
...
# Normalize the data.
echo "copy clean to normalization"
...
cp $Data_path/cleaned_data/test.txt $Data_path/normalized/test.txt
cp $Data_path/cleaned_data/train.txt $Data_path/normalized/train.txt
cp $Data_path/cleaned_data/valid.txt $Data_path/normalized/valid.txt
