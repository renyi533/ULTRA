...
Model_path="/workspace/user_code_old/jupyter-notebook/violatang/l2r-paper/models/movielens_binary"
...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Model_path/tmp_model_${task_name}/ --output_dir=$Data_path/tmp_output/ --setting_file=./example/offline_setting_reward/biastower_mtl_sep_clickdot_wtsum_evalreward_exp_settings.json"
echo $SETTING_ARGS
