...
Model_path="/workspace/user_code/violatang/l2-paper/movielens_binary/models/"
...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Model_path/tmp_model_${task_name}/ --output_dir=$Data_path/tmp_output/ --setting_file=./example/offline_setting_reward/pairwise_regression_EM_mtl_nopointcorr_nodecay_extractipstrue_linearndcg_evalreward_exp_settings.json"
echo $SETTING_ARGS

rm -rf $Model_path/tmp_model_${task_name}/

# Run model
python3 main.py --max_train_iteration=2500 $SETTING_ARGS
