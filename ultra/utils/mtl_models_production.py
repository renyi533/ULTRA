...
class ClickModel:
    def __init__(self, neg_click_prob=0.0, pos_click_prob=1.0,
        ...
        self.setUnbiasedWatchtimeDist(relevance_grading_num)
    ...
    def setUnbiasedWatchtimeDist(self, relevance_grading_num):
        # mean and std of watchtime
        self.unbiased_watchtime_mean = [0.80943809, 1.82523316, 2.78019793, 4.03966641, 4.62429015]
        self.unbiased_watchtime_std = [0.6078665, 0.6194569, 0.62937372, 0.7163962, 0.3134798]	
...
class PositionBiasedModel(ClickModel):
    ...
    def getUnbiasedWatchtime(self, relevance_label):
        ...
        return math.exp(t) / math.exp(3.0)
...
def main():
    ...
    with open(output_path + '/' + '_'.join(sys.argv[1:7]) + '.json', 'w') as fout:
        fout.write(
            json.dumps(
