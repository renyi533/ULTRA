...
class ClickModel:
	...
	# mean and std of watch time bias
        self.watchtime_bias_mean = [2/math.sqrt(i+2) for i in range(max_position+1)]
        self.watchtime_bias_std = [math.pow(i+1.0, 1.0/3)/(max_position+1) for i in range(max_position+1)]
