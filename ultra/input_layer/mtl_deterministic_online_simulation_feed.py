...
class MTLDeterministicOnlineSimulationFeed(BaseInputFeed):
        ...
        for i in range(local_batch_size):
            ...
            if self.hparams.oracle_mode:
                ...
                for j in range(0, len(click_list)):
                    ...
                    #print("viola in click_list click:%s, watchtime:%s" %(click_list[j], watchtime_list[j]))
            # update input_feed
            for j in range(list_len):
