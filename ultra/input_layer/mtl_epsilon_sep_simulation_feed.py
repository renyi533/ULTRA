...
from ultra.utils import click_models_mtl_epsilon as cm
import ultra.utils
...
class MTLEpsilonSepSimulationFeed(BaseInputFeed):
    ...
    def __init__(self, model, batch_size, hparam_str, session=None):
        ...
        self.hparams = ultra.utils.hparams.HParams(
            ...
            click_model_json='./example/ClickModelMTL_epsilon/pbm_0.1_1_4_1.0_0.1_10.json',
        ...
        print('Create MTL Epsilon simluated separated label feed')
        print(hparam_str)
